...
- **Alignment pool** — the complete set of aligned read inputs belonging to one patient, sample, and modality. Lanes and library repeats are members of the pool, not separate biological samples; independent libraries retain their identities within it.
