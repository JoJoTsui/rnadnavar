...
`examples/seqc2/comparison/updated_policy_validation_20260914_final7/validation_report.json`
...
The static routing and bounded read-evidence audit confirms that the same generic native/rescue flags are
