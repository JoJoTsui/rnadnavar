# caller-vcf-rust-parser

## Purpose

Rust-based parsing of 6 caller VCFs (DNA/RNA × Mutect2/DeepSomatic/Strelka) matching variants on all 4 coordinate columns (CHROM, POS, REF, ALT) with early termination and GIL release.
