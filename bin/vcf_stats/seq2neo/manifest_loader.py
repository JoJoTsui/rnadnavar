...
CALLER_CONFIGS: dict[str, dict[str, str]] = {
    "DNA_mutect2": {
        "subdir": "variant_calling/mutect2/{prefix}DT_vs_{prefix}DN",
        "pattern": "*.mutect2.filtered.vcf.gz",
        "sample_suffix": "DT",
        "format_fields": "GT,AD,AF,DP",
    },
    "RNA_mutect2": {
        "subdir": "vcf_realignment/variant_calling/mutect2/{prefix}RT_realign_vs_{prefix}DN",
        "pattern": "*.mutect2.filtered.vcf.gz",
        "sample_suffix": "RT",
        "format_fields": "GT,AD,AF,DP",
    },
    "DNA_deepsomatic": {
        "subdir": "variant_calling/deepsomatic/{prefix}DT_vs_{prefix}DN",
        "pattern": "*.deepsomatic.vcf.gz",
        "sample_suffix": "DT",
        "format_fields": "GT,AD,VAF,DP",
    },
    "RNA_deepsomatic": {
        "subdir": "vcf_realignment/variant_calling/deepsomatic/{prefix}RT_realign_vs_{prefix}DN",
        "pattern": "*.deepsomatic.vcf.gz",
        "sample_suffix": "RT",
        "format_fields": "GT,AD,VAF,DP",
    },
    "DNA_strelka": {
        "subdir": "variant_calling/strelka/{prefix}DT_vs_{prefix}DN",
        "pattern": "*.strelka.variants.vcf.gz",
        "sample_suffix": "TUMOR",
        "format_fields": "DP,TAR,TIR,TOR",
    },
    "RNA_strelka": {
        "subdir": "vcf_realignment/variant_calling/strelka/{prefix}RT_realign_vs_{prefix}DN",
        "pattern": "*.strelka.variants.vcf.gz",
        "sample_suffix": "TUMOR",
        "format_fields": "DP,TAR,TIR,TOR",
    },
